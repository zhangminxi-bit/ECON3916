...
- **Optimal K:** Silhouette analysis peaked at K = ___. *(Fill in after running the notebook.)* The elbow plot showed diminishing WCSS returns beyond K = 4–5, suggesting the four-group structure is data-supported, not just imposed by analogy to World Bank classifications.
